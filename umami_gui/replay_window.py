...
class ReplayWindow(QtWidgets.QWidget):
    ...
    def __init__(self, client):
        ...
        self.root_path = QtWidgets.QLineEdit()
    ...
    def _refresh_list(self):
        ...
        color = QtWidgets.QApplication.palette().color(QtGui.QPalette.ColorRole.Text)
        for entry in sorted(p.name for p in root.iterdir() if p.is_dir()):
            ...
            self.run_list.addItem(QtWidgets.QListWidgetItem(icon, entry))
